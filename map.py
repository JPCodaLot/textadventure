m = {
  ...
  "rooms":[
    ...
    },
    {
      ...
      "description":"You have now entered room 4. This second room is faintly lit with a small window letting the moonlight in.",
      "item":"Mag Glass",
    ...
    },
    {
      ...
      "description":"You have found the treasure and killed the beast with the pistol. You have won the game!",
      "require":["Gold Key","Pistol","Gem","Potion"],
      "clue":"You do not have all the needed items to continue to this room.",
      "exits":{}
    }
  ]
}
